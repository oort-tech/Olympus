...
namespace mcp
{
	namespace p2p
	{
		...
		private:
			...
			void setAuthValues(mcp::signature const& sig, mcp::public_key const& _hePubk, mcp::public_key const& remotePubk, mcp::nonce const& remoteNonce);
			...
			mcp::public_key m_ecdheRemote;			///< Remote ephemeral public key.
