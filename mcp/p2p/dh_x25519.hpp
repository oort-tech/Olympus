...
namespace mcp
{
	namespace p2p
	{
		void encrypt_dh(mcp::public_key const& _k, dev::bytesConstRef _plain, dev::bytes& o_cipher);
		...
		*/
		...
		public:
			...
			void encrypt_x25519(mcp::public_key const& _k, dev::bytes& io_cipher);

			/// Encrypts text (replace input). curve25519
			void encrypt_x25519(mcp::public_key const& _k, dev::bytesConstRef _sharedMacData, dev::bytes& io_cipher);
