...
import interestSetterJson from '../../build/contracts/IInterestSetter.json';
import priceOracleJson from '../../build/contracts/IPriceOracle.json';
import expiryJson from '../../build/contracts/Expiry.json';
import expiryV2Json from '../../build/contracts/ExpiryV2.json';
import finalSettlementJson from '../../build/contracts/FinalSettlement.json';
import refunderJson from '../../build/contracts/Refunder.json';
import daiMigratorJson from '../../build/contracts/DaiMigrator.json';
import limitOrdersJson from '../../build/contracts/LimitOrders.json';
import stopLimitOrdersJson from '../../build/contracts/StopLimitOrders.json';
import canonicalOrdersJson from '../../build/contracts/CanonicalOrders.json';
import payableProxyJson from '../../build/contracts/PayableProxyForSoloMargin.json';
import signedOperationProxyJson from '../../build/contracts/SignedOperationProxy.json';
import liquidatorV1Json from '../../build/contracts/LiquidatorProxyV1ForSoloMargin.json';
...
import wethPriceOracleJson from '../../build/contracts/WethPriceOracle.json';
import daiPriceOracleJson from '../../build/contracts/DaiPriceOracle.json';
import usdcPriceOracleJson from '../../build/contracts/UsdcPriceOracle.json';
...
export class Contracts {
  ...
  constructor(
    ...
    this.weth = new this.web3.eth.Contract(wethJson.abi) as WETH9;
