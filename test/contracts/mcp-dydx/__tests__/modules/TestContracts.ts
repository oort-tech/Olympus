...
import omiseTokenJson from '../../build/contracts/OmiseToken.json';
import testLibJson from '../../build/contracts/TestLib.json';
...
import testSimpleCalleeJson from '../../build/contracts/TestSimpleCallee.json';
...
import testMakerOracleJson from '../../build/contracts/TestMakerOracle.json';
import testCurveJson from '../../build/contracts/TestCurve.json';
import testUniswapV2PairJson from '../../build/contracts/TestUniswapV2Pair.json';
import testUniswapV2Pair2Json from '../../build/contracts/TestUniswapV2Pair2.json';
