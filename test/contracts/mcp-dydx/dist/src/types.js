...
(function (ApiOrderTypeV2) {
    ...
    ApiOrderTypeV2["CANONICAL_CROSS"] = "CANONICAL_CROSS";
    ApiOrderTypeV2["CANONICAL_SPOT"] = "CANONICAL_SPOT";
    ApiOrderTypeV2["CANONICAL_SPOT_STOP_LIMIT"] = "CANONICAL_SPOT_STOP_LIMIT";
    ApiOrderTypeV2["CANONICAL_STOP_LIMIT"] = "CANONICAL_STOP_LIMIT";
    ApiOrderTypeV2["CANONICAL_ISOLATED_STOP_LIMIT"] = "CANONICAL_ISOLATED_STOP_LIMIT";
    ApiOrderTypeV2["CANONICAL_ISOLATED_OPEN"] = "CANONICAL_ISOLATED_OPEN";
    ApiOrderTypeV2["CANONICAL_ISOLATED_PARTIAL_CLOSE"] = "CANONICAL_ISOLATED_PARTIAL_CLOSE";
    ApiOrderTypeV2["CANONICAL_ISOLATED_FULL_CLOSE"] = "CANONICAL_ISOLATED_FULL_CLOSE";
    ApiOrderTypeV2["CANONICAL_ISOLATED_TAKE_PROFIT"] = "CANONICAL_ISOLATED_TAKE_PROFIT";
    ApiOrderTypeV2["PERPETUAL_CROSS"] = "PERPETUAL_CROSS";
    ApiOrderTypeV2["PERPETUAL_STOP_LIMIT"] = "PERPETUAL_STOP_LIMIT";
...
exports.AccountNumbers = {
    SPOT: new bignumber_js_1.default('78249916358380492593314239409032173911741268194868200833150293576330928686520'),
    MARGIN: new bignumber_js_1.default('0'),
};
var OffChainAction;
(function (OffChainAction) {
    OffChainAction["LOGIN"] = "Login";
    OffChainAction["CANCEL_ALL"] = "CancelAll";
})(OffChainAction = exports.OffChainAction || (exports.OffChainAction = {}));
