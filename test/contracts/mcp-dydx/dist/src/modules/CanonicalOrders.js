...
var CanonicalOrders = /** @class */ (function (_super) {
    ...
    CanonicalOrders.prototype.stringifyOrder = function (order) {
        var stringifiedOrder = __assign({}, order, { flags: this.getCanonicalOrderFlags(order), limitPrice: this.toSolidity(order.limitPrice), triggerPrice: this.toSolidity(order.triggerPrice), limitFee: this.toSolidity(order.limitFee) });
        for (var _i = 0, _a = Object.entries(stringifiedOrder); _i < _a.length; _i++) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contracts.call(this.contracts.canonicalOrders.methods.getOrderStates(orderHashes), options)];
                    case 1:
                        states = _a.sent();
    ...
    CanonicalOrders.prototype.getTakerAddress = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.canonicalOrders.methods.g_taker(), options)];
            });
        });
    };
    ...
    CanonicalOrders.prototype.setTakerAddress = function (taker, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.send(this.contracts.canonicalOrders.methods.setTakerAddress(taker), options)];
            });
        });
    };
    ...
    CanonicalOrders.prototype.getFeeForOrder = function (baseMarketBN, amount, isTaker) {
        ...
        var ETH_SMALL_ORDER_THRESHOLD = new bignumber_js_1.default('20e18');
        var DAI_SMALL_ORDER_THRESHOLD = new bignumber_js_1.default('10000e18');
