...
var Weth = /** @class */ (function () {
    ...
    Weth.prototype.wrap = function (ownerAddress, amount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.send(this.weth.methods.deposit(), __assign({}, options, { from: ownerAddress, value: amount.toFixed(0) }))];
            });
        });
    };
    Weth.prototype.unwrap = function (ownerAddress, amount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.send(this.weth.methods.withdraw(amount.toFixed(0)), __assign({}, options, { from: ownerAddress }))];
            });
        });
    };
