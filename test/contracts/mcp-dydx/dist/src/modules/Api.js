...
var Api = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, __assign({}, order, { typedSignature: typedSignature })];
                }
            });
        });
    };
    ...
    Api.prototype.submitCanonicalOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, this.axiosRequest({
                        data: data,
    ...
    Api.prototype.axiosRequest = function (_a) {
        var url = _a.url, method = _a.method, headers = _a.headers, data = _a.data;
        return __awaiter(this, void 0, void 0, function () {
            var response, error_1, message, newError;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        error_1 = _b.sent();
                        message = lodash_1.default.get(error_1, 'response.data.errors[0].msg') || error_1.message;
                        newError = new Error(message);
                        newError.stack = error_1.stack;
                        if (error_1.response) {
                            // Include selected data from the response. Don't include the whole response, which may
                            // contain circular references.
                            newError.response = lodash_1.default.pick(error_1.response, ['data', 'status', 'statusText']);
                        }
                        throw newError;
