...
var EIP712_ORDER_STRUCT_STRING = 'StopLimitOrder(' +
    'uint256 makerMarket,' +
    'uint256 takerMarket,' +
    'uint256 makerAmount,' +
    'uint256 takerAmount,' +
...
var EIP712_CANCEL_ORDER_STRUCT_STRING = 'CancelLimitOrder(' +
    ...
    'bytes32[] orderHashes' +
    ')';
var StopLimitOrders = /** @class */ (function (_super) {
    __extends(StopLimitOrders, _super);
    // ============ Constructor ============
    function StopLimitOrders(contracts, web3, networkId) {
     ...
     */
    StopLimitOrders.prototype.getOrderStates = function (orders, options) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contracts.call(this.contracts.stopLimitOrders.methods.getOrderStates(orderHashes), options)];
                    case 1:
                        states = _a.sent();
     ...
     */
    StopLimitOrders.prototype.getAccountCollateralizationAfterMakingOrders = function (weis, prices, orders, remainingMakerAmounts) {
     ...
     */
    StopLimitOrders.prototype.getDomainHash = function () {
        return web3_1.default.utils.soliditySha3({ t: 'bytes32', v: BytesHelper_1.hashString(SignatureHelper_1.EIP712_DOMAIN_STRING) }, { t: 'bytes32', v: BytesHelper_1.hashString('StopLimitOrders') }, { t: 'bytes32', v: BytesHelper_1.hashString('1.1') }, { t: 'uint256', v: Helpers_1.toString(this.networkId) }, { t: 'bytes32', v: BytesHelper_1.addressToBytes32(this.contracts.stopLimitOrders.options.address) });
    };
    // ============ To-Bytes Functions ============
    StopLimitOrders.prototype.unsignedOrderToBytes = function (order) {
        return web3_1.default.utils.bytesToHex(this.orderToByteArray(order));
    };
    StopLimitOrders.prototype.signedOrderToBytes = function (order) {
    ...
    StopLimitOrders.prototype.orderToByteArray = function (order) {
        return []
            ...
            .concat(BytesHelper_1.argToBytes(order.triggerPrice))
            .concat(BytesHelper_1.argToBytes(order.decreaseOnly))
            .concat(BytesHelper_1.argToBytes(order.expiration))
            .concat(BytesHelper_1.argToBytes(order.salt));
    };
    StopLimitOrders.prototype.getDomainData = function () {
        return {
    ...
    StopLimitOrders.prototype.ethSignTypedOrderInternal = function (order, signingMethod) {
        return __awaiter(this, void 0, void 0, function () {
            var orderData, data;
            return __generator(this, function (_a) {
                orderData = {
    ...
    StopLimitOrders.prototype.ethSignTypedCancelOrderInternal = function (orderHash, signer, signingMethod) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                data = {
    ...
    StopLimitOrders.prototype.stringifyOrder = function (order) {
    ...
    StopLimitOrders.prototype.getContract = function () {
        return this.contracts.stopLimitOrders;
    };
    return StopLimitOrders;
}(OrderSigner_1.OrderSigner));
exports.StopLimitOrders = StopLimitOrders;
//# sourceMappingURL=StopLimitOrders.js.map