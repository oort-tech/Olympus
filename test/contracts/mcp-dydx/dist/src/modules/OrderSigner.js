...
var OrderSigner = /** @class */ (function (_super) {
    ...
    OrderSigner.prototype.isOperational = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.getContract().methods.g_isOperational(), options)];
            });
        });
    };
    ...
    OrderSigner.prototype.approveOrder = function (order, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contracts.send(this.getContract().methods.approveOrder(stringifiedOrder), options)];
            });
        });
    };
    /**
    ...
    OrderSigner.prototype.cancelOrder = function (order, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                stringifiedOrder = this.stringifyOrder(order);
                return [2 /*return*/, this.contracts.send(this.getContract().methods.cancelOrder(stringifiedOrder), options)];
            });
        });
    };
    // ============ Signing Methods ============
