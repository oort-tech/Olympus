...
var Token = /** @class */ (function () {
    ...
    Token.prototype.setAllowance = function (tokenAddress, ownerAddress, spenderAddress, amount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                token = this.getToken(tokenAddress);
                return [2 /*return*/, this.contracts.send(token.methods.approve(spenderAddress, amount.toFixed(0)), __assign({}, options, { from: ownerAddress }))];
            });
        });
    };
    ...
    Token.prototype.transfer = function (tokenAddress, fromAddress, toAddress, amount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                token = this.getToken(tokenAddress);
                return [2 /*return*/, this.contracts.send(token.methods.transfer(toAddress, amount.toFixed(0)), __assign({}, options, { from: fromAddress }))];
            });
        });
    };
    Token.prototype.transferFrom = function (tokenAddress, fromAddress, toAddress, senderAddress, amount, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                token = this.getToken(tokenAddress);
                return [2 /*return*/, this.contracts.send(token.methods.transferFrom(fromAddress, toAddress, amount.toFixed(0)), __assign({}, options, { from: senderAddress }))];
            });
        });
    };
