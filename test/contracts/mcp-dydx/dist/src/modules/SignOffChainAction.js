...
var EIP712_WALLET_OFF_CHAIN_ACTION_ALL_STRUCT = [
    { type: 'string', name: 'action' },
    { type: 'string', name: 'expiration' },
];
var SignOffChainAction = /** @class */ (function (_super) {
    __extends(SignOffChainAction, _super);
    function SignOffChainAction(web3, networkId, _a) {
        ...
        _this.EIP712_OFF_CHAIN_ACTION_ALL_STRUCT_STRING = 'dYdX(' +
            'string action,' +
            'string expiration' +
            ')';
        return _this;
    }
    SignOffChainAction.prototype.signOffChainAction = function (expiration, signer, signingMethod, action) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, hash, rawSignature, hashSig, unsafeHashSig, data;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1:
                        hash = this.getOffChainActionHash(expiration, action);
                    ...
                    case 3:
                        {
                            data = {
                                types: (_a = {
                                    ...
                                    _a[this.domain] = EIP712_WALLET_OFF_CHAIN_ACTION_ALL_STRUCT,
                                    _a),
    ...
    SignOffChainAction.prototype.signOffChainActionIsValid = function (expiration, typedSignature, expectedSigner, action) {
        var hash = this.getOffChainActionHash(expiration, action);
    ...
    SignOffChainAction.prototype.getDomainHash = function () {
    ...
    SignOffChainAction.prototype.getOffChainActionHash = function (expiration, action) {
        var structHash = web3_1.default.utils.soliditySha3({ t: 'bytes32', v: BytesHelper_1.hashString(this.EIP712_OFF_CHAIN_ACTION_ALL_STRUCT_STRING) }, { t: 'bytes32', v: BytesHelper_1.hashString(action) }, { t: 'bytes32', v: BytesHelper_1.hashString(expiration.toUTCString()) });
        return this.getEIP712Hash(structHash);
    };
    SignOffChainAction.prototype.getDomainData = function () {
        return {
            name: this.domain,
    ...
    return SignOffChainAction;
}(Signer_1.Signer));
exports.SignOffChainAction = SignOffChainAction;
//# sourceMappingURL=SignOffChainAction.js.map