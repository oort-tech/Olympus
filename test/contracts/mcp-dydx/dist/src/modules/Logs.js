...
var ExpiryV2_json_1 = require("../../build/contracts/ExpiryV2.json");
var FinalSettlement_json_1 = require("../../build/contracts/FinalSettlement.json");
var Refunder_json_1 = require("../../build/contracts/Refunder.json");
var LimitOrders_json_1 = require("../../build/contracts/LimitOrders.json");
var StopLimitOrders_json_1 = require("../../build/contracts/StopLimitOrders.json");
var CanonicalOrders_json_1 = require("../../build/contracts/CanonicalOrders.json");
var SignedOperationProxy_json_1 = require("../../build/contracts/SignedOperationProxy.json");
var Logs = /** @class */ (function () {
    ...
    Logs.prototype.parseLogs = function (receipt, options) {
        ...
        if (options.skipFinalSettlementLogs) {
            logs = logs.filter(function (log) { return !_this.logIsFrom(log, FinalSettlement_json_1.abi); });
        }
    ...
    Logs.prototype.parseLogWithContract = function (contract, log) {
        ...
        return __assign({}, log, { name: eventJson.name, args: this.parseArgs(eventJson, eventArgs) });
    };
