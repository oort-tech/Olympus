...
var AccountOperation = /** @class */ (function () {
    ...
    AccountOperation.prototype.finalSettlement = function (settlement) {
        this.addActionArgs({
            ...
            otherAccountId: this.getAccountId(settlement.liquidAccountOwner, settlement.liquidAccountId),
            otherAddress: this.contracts.finalSettlement.options.address,
            data: BytesHelper_1.toBytes(settlement.liquidMarketId),
        });
        return this;
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                try {
                    ...
                    return [2 /*return*/, this.contracts.send(method, options)];
                }
                catch (error) {
                    this.committed = false;
                    throw error;
    ...
    AccountOperation.prototype.exchange = function (exchange, actionType) {
        ...
        var _b = actionType === types_1.ActionType.Buy ?
            [exchange.makerMarketId, exchange.takerMarketId] :
            [exchange.takerMarketId, exchange.makerMarketId], primaryMarketId = _b[0], secondaryMarketId = _b[1];
    ...
    AccountOperation.prototype.generateAuthData = function () {
        ...
        for (var i = 0; i < this.auths.length; i += 1) {
            ...
            if (auth.startIndex.gt(actionIndex)) {
                result.push(__assign({}, emptyAuth, { numActions: auth.startIndex.minus(actionIndex).toFixed(0) }));
            }
            // push this auth
            result.push({
        ...
        if (actionIndex.lt(this.actions.length)) {
            result.push(__assign({}, emptyAuth, { numActions: new bignumber_js_1.default(this.actions.length).minus(actionIndex).toFixed(0) }));
        }
        return result;
    };
