...
var MakerStablecoinPriceOracle = /** @class */ (function () {
    ...
    MakerStablecoinPriceOracle.prototype.setPokerAddress = function (newPoker, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.send(this.oracleContract.methods.ownerSetPokerAddress(newPoker), options)];
            });
        });
    };
    // ============ Setters ============
    MakerStablecoinPriceOracle.prototype.updatePrice = function (minimum, maximum, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contracts.send(this.oracleContract.methods.updatePrice({ value: minimumArg.toFixed(0) }, { value: maximumArg.toFixed(0) }), options)];
            });
        });
    };
    // ============ Getters ============
    MakerStablecoinPriceOracle.prototype.getOwner = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.oracleContract.methods.owner(), options)];
            });
        });
    };
    MakerStablecoinPriceOracle.prototype.getPoker = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.g_poker(), options)];
                    case 1:
                        poker = _a.sent();
    ...
    MakerStablecoinPriceOracle.prototype.getPrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getPrice(Constants_1.ADDRESSES.ZERO), options)];
                    case 1:
                        price = _a.sent();
    ...
    MakerStablecoinPriceOracle.prototype.getPriceInfo = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.g_priceInfo(), options)];
                    case 1:
                        priceInfo = _a.sent();
                        return [2 /*return*/, {
    ...
    MakerStablecoinPriceOracle.prototype.getBoundedTargetPrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getBoundedTargetPrice(), options)];
                    case 1:
                        price = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(price.value)];
                }
    ...
    MakerStablecoinPriceOracle.prototype.getTargetPrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getTargetPrice(), options)];
                    case 1:
                        price = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(price.value)];
                }
    ...
    MakerStablecoinPriceOracle.prototype.getMedianizerPrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getMedianizerPrice(), options)];
                    case 1:
                        price = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(price.value)];
                }
    ...
    MakerStablecoinPriceOracle.prototype.getCurvePrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var price;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getCurvePrice(), options)];
                    case 1:
                        price = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(price)];
                }
            });
        });
    };
    MakerStablecoinPriceOracle.prototype.getUniswapPrice = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var price;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.getUniswapPrice(), options)];
                    case 1:
                        price = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.default(price)];
                }
    ...
    MakerStablecoinPriceOracle.prototype.getDeviationParams = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.oracleContract.methods.DEVIATION_PARAMS(), options)];
                    case 1:
                        params = _a.sent();
                        return [2 /*return*/, {
