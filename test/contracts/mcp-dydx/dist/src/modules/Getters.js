...
var Getters = /** @class */ (function () {
    ...
    Getters.prototype.getMarginRatio = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarginRatio(), options)];
                    case 1:
                        result = _a.sent();
    ...
    Getters.prototype.getLiquidationSpread = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getLiquidationSpread(), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Helpers_1.stringToDecimal(result.value)];
                }
    ...
    Getters.prototype.getEarningsRate = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getEarningsRate(), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Helpers_1.stringToDecimal(result.value)];
                }
    ...
    Getters.prototype.getMinBorrowedValue = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMinBorrowedValue(), options)];
                    case 1:
                        result = _a.sent();
    ...
    Getters.prototype.getRiskParams = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getRiskParams(), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    Getters.prototype.getRiskLimits = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getRiskLimits(), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    Getters.prototype.getNumMarkets = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getNumMarkets(), options)];
                    case 1:
                        result = _a.sent();
    ...
    Getters.prototype.getMarketTokenAddress = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketTokenAddress(marketId.toFixed(0)), options)];
            });
        });
    };
    Getters.prototype.getMarketTotalPar = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketTotalPar(marketId.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    Getters.prototype.getMarketCachedIndex = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketCachedIndex(marketId.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
    ...
    Getters.prototype.getMarketCurrentIndex = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketCurrentIndex(marketId.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, this.parseIndex(result)];
                }
    ...
    Getters.prototype.getMarketPriceOracle = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketPriceOracle(marketId.toFixed(0)), options)];
            });
        });
    };
    Getters.prototype.getMarketInterestSetter = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketInterestSetter(marketId.toFixed(0)), options)];
            });
        });
    };
    Getters.prototype.getMarketMarginPremium = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketMarginPremium(marketId.toFixed(0)), options)];
                    case 1:
    ...
    Getters.prototype.getMarketSpreadPremium = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketSpreadPremium(marketId.toFixed(0)), options)];
                    case 1:
    ...
    Getters.prototype.getMarketIsClosing = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketIsClosing(marketId.toFixed(0)), options)];
            });
        });
    };
    Getters.prototype.getMarketPrice = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketPrice(marketId.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.BigNumber(result.value)];
                }
    ...
    Getters.prototype.getMarketInterestRate = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketInterestRate(marketId.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Helpers_1.stringToDecimal(result.value)];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), earningsRate = _a[0], borrowInterestRate = _a[1], utilization = _a[2];
    ...
    Getters.prototype.getLiquidationSpreadForPair = function (heldMarketId, owedMarketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getLiquidationSpreadForPair(heldMarketId.toFixed(0), owedMarketId.toFixed(0)), options)];
                    case 1:
                        spread = _a.sent();
    ...
    Getters.prototype.getMarket = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarket(marketId.toFixed(0)), options)];
                    case 1:
                        market = _a.sent();
                        return [2 /*return*/, __assign({}, market, { totalPar: this.parseTotalPar(market.totalPar), index: this.parseIndex(market.index), marginPremium: Helpers_1.stringToDecimal(market.marginPremium.value), spreadPremium: Helpers_1.stringToDecimal(market.spreadPremium.value) })];
                }
            });
        });
    };
    Getters.prototype.getMarketWithInfo = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getMarketWithInfo(marketId.toFixed(0)), options)];
                    case 1:
                        ...
                        return [2 /*return*/, {
                                market: __assign({}, market, { totalPar: this.parseTotalPar(market.totalPar), index: this.parseIndex(market.index), marginPremium: Helpers_1.stringToDecimal(market.marginPremium.value), spreadPremium: Helpers_1.stringToDecimal(market.spreadPremium.value) }),
    ...
    Getters.prototype.getNumExcessTokens = function (marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getNumExcessTokens(marketId.toFixed(0)), options)];
                    case 1:
    ...
    Getters.prototype.getAccountPar = function (accountOwner, accountNumber, marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAccountPar({
                            owner: accountOwner,
    ...
    Getters.prototype.getAccountWei = function (accountOwner, accountNumber, marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAccountWei({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }, marketId.toFixed(0)), options)];
                    case 1:
    ...
    Getters.prototype.getAccountStatus = function (accountOwner, accountNumber, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAccountStatus({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }), options)];
                    case 1:
    ...
    Getters.prototype.getAccountValues = function (accountOwner, accountNumber, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAccountValues({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }), options)];
                    case 1:
    ...
    Getters.prototype.getAdjustedAccountValues = function (accountOwner, accountNumber, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAdjustedAccountValues({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }), options)];
                    case 1:
    ...
    Getters.prototype.getAccountBalances = function (accountOwner, accountNumber, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.soloMargin.methods.getAccountBalances({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }), options)];
                    case 1:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), accountStatus = _a[0], marginRatio = _a[1], accountValues = _a[2];
    ...
    Getters.prototype.getIsLocalOperator = function (owner, operator, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getIsLocalOperator(owner, operator), options)];
            });
        });
    };
    Getters.prototype.getIsGlobalOperator = function (operator, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.getIsGlobalOperator(operator), options)];
            });
        });
    };
    // ============ Getters for Admin ============
    Getters.prototype.getAdmin = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.soloMargin.methods.owner(), options)];
            });
        });
    };
    // ============ Getters for Expiry ============
    Getters.prototype.getExpiryAdmin = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.expiry.methods.owner(), options)];
            });
        });
    };
    Getters.prototype.getExpiry = function (accountOwner, accountNumber, marketId, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.expiry.methods.getExpiry({
                            owner: accountOwner,
                            number: accountNumber.toFixed(0),
                        }, marketId.toFixed(0)), options)];
                    case 1:
    ...
    Getters.prototype.getExpiryPrices = function (heldMarketId, owedMarketId, expiryTimestamp, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.expiry.methods.getSpreadAdjustedPrices(heldMarketId.toFixed(0), owedMarketId.toFixed(0), expiryTimestamp.toFixed(0)), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    Getters.prototype.getExpiryRampTime = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.call(this.contracts.expiry.methods.g_expiryRampTime(), options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, new bignumber_js_1.BigNumber(result)];
                }
