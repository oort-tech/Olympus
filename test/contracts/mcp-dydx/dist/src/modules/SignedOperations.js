...
var SignedOperations = /** @class */ (function (_super) {
    ...
    SignedOperations.prototype.cancelOperation = function (operation, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contracts.send(this.contracts.signedOperationProxy.methods.cancel(accounts, actions, {
    ...
    SignedOperations.prototype.isOperational = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.contracts.signedOperationProxy.methods.g_isOperational(), options)];
            });
        });
    };
    /**
    ...
    SignedOperations.prototype.getOperationsAreInvalid = function (operations, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.contracts.call(this.contracts.signedOperationProxy.methods.getOperationsAreInvalid(hashes), options)];
            });
        });
    };
    // ============ Signing Methods ============
