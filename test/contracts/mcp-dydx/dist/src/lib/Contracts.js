...
var FinalSettlement_json_1 = __importDefault(require("../../build/contracts/FinalSettlement.json"));
...
var Contracts = /** @class */ (function () {
    function Contracts(provider, networkId, web3, options) {
        ...
        this.finalSettlement = new this.web3.eth.Contract(FinalSettlement_json_1.default.abi);
        ...
        this.weth = new this.web3.eth.Contract(WETH9_json_1.default.abi);
    ...
    Contracts.prototype.setProvider = function (provider, networkId) {
        ...
        var contracts = [
            ...
            { contract: this.finalSettlement, json: FinalSettlement_json_1.default },
            ...
            { contract: this.weth, json: WETH9_json_1.default },
        ];
    ...
    Contracts.prototype.send = function (method, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, method.estimateGas(this.toEstimateOptions(txOptions))];
                    case 4:
                        gasEstimate = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
                    ...
                    case 8:
                        ...
                        promi = method.send(this.toNativeSendOptions(txOptions));
                        OUTCOMES = {
                            INITIAL: 0,
                            RESOLVED: 1,
                            REJECTED: 2,
                    ...
                    case 9:
                        ...
                        return [2 /*return*/, this.normalizeResponse({ transactionHash: transactionHash_1 })];
                    case 10:
                    ...
                    case 11:
                        ...
                        return [2 /*return*/, this.normalizeResponse({
    ...
    Contracts.prototype.call = function (method, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, blockNumber, txOptions, m2;
            return __generator(this, function (_b) {
                _a = this.toCallOptions(options), blockNumber = _a.blockNumber, txOptions = __rest(_a, ["blockNumber"]);
                m2 = method;
                return [2 /*return*/, m2.call(txOptions, blockNumber || 'latest')];
            });
        });
    };
    ...
    // ============ Parse Options ============
    Contracts.prototype.toEstimateOptions = function (txOptions) {
        return {
            from: txOptions.from,
            value: txOptions.value,
        };
    };
    Contracts.prototype.toCallOptions = function (options) {
        return {
            from: options.from,
            value: options.value,
    ...
    Contracts.prototype.toNativeSendOptions = function (options) {
        return {
            from: options.from,
            value: options.value,
    ...
    Contracts.prototype.normalizeResponse = function (txResult) {
        var txHash = txResult.transactionHash;
        if (txHash) {
            var internalHash = txHash.transactionHash, internalNonce = txHash.nonce;
            if (internalHash) {
