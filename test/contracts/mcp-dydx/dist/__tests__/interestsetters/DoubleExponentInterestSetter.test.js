...
var defaultCoefficients = [20, 20, 20, 20, 20];
var defaultMaxAPR = new bignumber_js_1.default('1.00');
describe('DoubleExponentInterestSetter', function () {
    var snapshotId;
    beforeAll(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, solo.admin.addMarket(solo.testing.tokenA.getAddress(), solo.testing.priceOracle.getAddress(), solo.testing.doubleExponentInterestSetter.getAddress(), zero, zero, { from: admin })];
                case 4:
                    _a.sent();
    ...
    it('Succeeds for 50/100', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    rate = _a.sent();
                    expect(rate).toEqual(Helpers_1.getInterestPerSecondForDoubleExponent(defaultMaxAPR, defaultCoefficients, { totalBorrowed: par.div(2), totalSupply: par }));
                    return [2 /*return*/];
            }
        });
    }); });
    it('Succeeds for 100% (javscript)', function () { return __awaiter(_this, void 0, void 0, function () {
        var res1, res2;
        return __generator(this, function (_a) {
            res1 = Helpers_1.getInterestPerSecondForDoubleExponent(defaultMaxAPR, defaultCoefficients, { totalBorrowed: par, totalSupply: par });
            res2 = Helpers_1.getInterestPerSecondForDoubleExponent(defaultMaxAPR, defaultCoefficients, { totalBorrowed: par.times(2), totalSupply: par });
    ...
    it('Succeeds for gas', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    baseGasCost = 21000;
                    getRateFunction = solo.contracts.testDoubleExponentInterestSetter.methods.getInterestRate;
                    _b = (_a = Promise).all;
    ...
    it('Succeeds for some hardcoded numbers (1)', function () { return __awaiter(_this, void 0, void 0, function () {
        var testCases, i, borrowWei, supplywei, result, expectedResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setCoefficients(new bignumber_js_1.default('1e18'), [20, 20, 20, 20, 20])];
                case 1:
                    _a.sent();
                    testCases = [
                        [0, 0, '0'],
                ...
                case 2:
                    ...
                    borrowWei = new bignumber_js_1.default(testCases[i][0]);
                    supplywei = new bignumber_js_1.default(testCases[i][1]);
                    return [4 /*yield*/, solo.testing.doubleExponentInterestSetter.getInterestRate(borrowWei, supplywei)];
                case 3:
                    result = _a.sent();
                    expectedResult = new bignumber_js_1.default(testCases[i][2]);
    ...
    it('Succeeds for some hardcoded numbers (2)', function () { return __awaiter(_this, void 0, void 0, function () {
        var testCases, i, borrowWei, supplywei, result, expectedResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setCoefficients(new bignumber_js_1.default('1e18'), [0, 25, 25, 0, 25, 25])];
                case 1:
                    _a.sent();
                    testCases = [
                        [0, 0, '0'],
    ...
    it('Succeeds for bunch of utilization numbers', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    rate = _a.sent();
                    expect(rate).toEqual(Helpers_1.getInterestPerSecondForDoubleExponent(defaultMaxAPR, defaultCoefficients, {
    ...
    it('Succeeds for setting/getting maxAPR', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solo.contracts.testDoubleExponentInterestSetter.methods.getMaxAPR().call()];
                case 1:
                    maxAPR1 = _a.sent();
                    ...
                    return [4 /*yield*/, solo.contracts.send(solo.contracts.testDoubleExponentInterestSetter.methods.setParameters({
                            maxAPR: newAPR,
                            coefficients: '100',
                        }))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, solo.contracts.testDoubleExponentInterestSetter.methods.getMaxAPR().call()];
                case 3:
                    maxAPR2 = _a.sent();
    ...
    it("Fails to deploy contracts whose coefficients don't add to 100", function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.contracts.testDoubleExponentInterestSetter.methods.createNew({
                        maxAPR: '0',
...
function expectCoefficients(expected) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solo.contracts.testDoubleExponentInterestSetter.methods.getCoefficients().call()];
                case 1:
...
//# sourceMappingURL=DoubleExponentInterestSetter.test.js.map