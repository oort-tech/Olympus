...
var defaultGlob;
var CANNOT_WITHDRAW_POSITIVE = 'Exchange: Cannot transferOut positive';
var cachedWeis = {
    walletWei: zero,
    soloWei: zero,
};
describe('Withdraw', function () {
    ...
    it('Basic withdraw test', function () { return __awaiter(_this, void 0, void 0, function () {
        var txResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawOkay({})];
                case 2:
                    txResult = _a.sent();
                    return [4 /*yield*/, expectBalances(par, wei, wei, zero)];
                case 3:
                    _a.sent();
    ...
    it('Succeeds for events', function () { return __awaiter(_this, void 0, void 0, function () {
        var txResult, _a, marketIndex, collateralIndex, logs, operationLog, marketIndexLog, collateralIndexLog, withdrawLog;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, expectWithdrawOkay({ to: operator }, { from: operator })];
                case 2:
                    txResult = _b.sent();
                    return [4 /*yield*/, Promise.all([
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    // starting from zero
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawOkay(globs[i])];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar, negWei, wei, zero)];
                case 4:
                    _a.sent();
                ...
                case 9:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(zero, zero, wei, zero)];
                case 10:
                    _a.sent();
                    // starting positive (<par)
                    return [4 /*yield*/, Promise.all([
                ...
                case 12:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar.div(2), negWei.div(2), wei, zero)];
                case 13:
                    _a.sent();
                    // starting negative
                    return [4 /*yield*/, Promise.all([
                ...
                case 15:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar.times(2), negWei.times(2), wei, zero)];
                case 16:
                    _a.sent();
                    _a.label = 17;
                case 17:
    ...
    it('Fails for positive delta par/wei', function () { return __awaiter(_this, void 0, void 0, function () {
        var reason, globs, i;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    reason = CANNOT_WITHDRAW_POSITIVE;
                    globs = [
                        {
                            amount: {
                                value: par,
                    ...
                    return [4 /*yield*/, issueTokensToSolo(wei)];
                case 1:
                    _a.sent();
                    i = 0;
                    _a.label = 2;
                ...
                case 3:
                    // starting from zero
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawRevert(globs[i], reason)];
                case 4:
                    _a.sent();
                    // starting positive
                    return [4 /*yield*/, setAccountBalance(par)];
    ...
    it('Mixed for negative target par/wei', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar, negWei, wei.div(2), zero)];
                case 7:
                    _a.sent();
                    // starting negative (=target)
                    return [4 /*yield*/, setAccountBalance(negPar)];
                ...
                case 10:
                    _a.sent();
                    // starting negative (>target)
                    return [4 /*yield*/, setAccountBalance(negPar.times(2))];
                case 11:
                    // starting negative (>target)
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawRevert(globs[i], CANNOT_WITHDRAW_POSITIVE)];
                case 12:
                    _a.sent();
                    // starting positive
                    return [4 /*yield*/, Promise.all([
                ...
                case 14:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar, negWei, wei.times(2), zero)];
                case 15:
                    _a.sent();
                    _a.label = 16;
                case 16:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    _a.sent();
                    // starting positive (>target)
                    return [4 /*yield*/, setAccountBalance(par.div(2))];
                case 10:
                    // starting positive (>target)
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawRevert(globs[i], CANNOT_WITHDRAW_POSITIVE)];
    ...
    it('Succeeds for withdrawing in par', function () { return __awaiter(_this, void 0, void 0, function () {
        var supplyIndex, expectedWei;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    supplyIndex = new bignumber_js_1.default('1.99');
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(zero, zero, expectedWei, zero)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Succeeds for withdrawing in wei', function () { return __awaiter(_this, void 0, void 0, function () {
        var supplyIndex, expectedWei;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('Succeeds for borrowing in par', function () { return __awaiter(_this, void 0, void 0, function () {
        var borrowIndex, expectedWei;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    borrowIndex = new bignumber_js_1.default('3.99');
                    expectedWei = par.times(borrowIndex).integerValue(bignumber_js_1.default.ROUND_DOWN);
                    return [4 /*yield*/, Promise.all([
                            issueTokensToSolo(expectedWei),
                            solo.testing.setMarketIndex(market, {
                                lastUpdate: Constants_1.INTEGERS.ZERO,
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(negPar, expectedWei.times(-1), expectedWei, zero)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Succeeds for borrowing in wei', function () { return __awaiter(_this, void 0, void 0, function () {
        var borrowIndex, expectedWei;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('Succeeds to withdraw to an external address', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        setAccountBalance(par),
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawOkay({ to: operator })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, expectBalances(zero, zero, zero, zero, wei)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Succeeds to withdraw to the SoloMargin address', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        setAccountBalance(par),
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawOkay({ to: solo.contracts.soloMargin.options.address })];
                case 2:
                    _a.sent();
    ...
    it('Succeeds for local operator', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawOkay({}, { from: operator })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Fails for non-operator', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, issueTokensToSolo(wei)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectWithdrawRevert({}, 'Storage: Unpermissioned operator', { from: operator })];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Fails if withdrawing more tokens than exist', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectWithdrawRevert({}, 'Token: Transfer failed')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function issueTokensToSolo(amount) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
function expectBalances(expectedPar, expectedWei, walletWei, soloWei, operatorWei) {
    if (operatorWei === void 0) { operatorWei = zero; }
    return __awaiter(this, void 0, void 0, function () {
        var _a, accountBalances, soloTokenBalance, walletTokenBalance, operatorTokenBalance;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, Promise.all([
                ...
                case 1:
                    _a = _b.sent(), accountBalances = _a[0], soloTokenBalance = _a[1], walletTokenBalance = _a[2], operatorTokenBalance = _a[3];
...
function expectWithdrawOkay(glob, options) {
    return __awaiter(this, void 0, void 0, function () {
        var combinedGlob;
        return __generator(this, function (_a) {
            combinedGlob = __assign({}, defaultGlob, glob);
            return [2 /*return*/, solo.operation.initiate().withdraw(combinedGlob).commit(options)];
        });
    });
}
function expectWithdrawRevert(glob, reason, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Expect_1.expectThrow(expectWithdrawOkay(glob, options), reason)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
