...
describe('Buy', function () {
    ...
    it('Basic buy test', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('Succeeds for events', function () { return __awaiter(_this, void 0, void 0, function () {
        var txResult, _a, makerIndex, takerIndex, collateralIndex, logs, operationLog, makerIndexLog, takerIndexLog, collateralIndexLog, buyLog;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    return [4 /*yield*/, expectBuyOkay({}, { from: operator })];
                case 2:
                    txResult = _b.sent();
                    return [4 /*yield*/, Promise.all([
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.sent();
                    return [4 /*yield*/, expectBuyOkay({
                            order: __assign({}, testOrder, { makerAmount: zero, desiredMakerAmount: zero }),
                            amount: {
                                value: zero,
                                denomination: types_1.AmountDenomination.Actual,
                                reference: types_1.AmountReference.Delta,
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _d.sent();
                    return [4 /*yield*/, expectBuyOkay({
                            order: __assign({}, testOrder, { takerAmount: zero, allegedTakerAmount: zero }),
                        })];
                case 2:
                    _d.sent();
                    _b = (_a = Promise).all;
    ...
    it('Fails for non-operator', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectBuyRevert({}, 'Storage: Unpermissioned operator', { from: operator })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Fails for negative makerAmount', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expectBuyRevert({
                        amount: {
    ...
    it('Fails for Solo without enough tokens', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectBuyRevert({}, 'Token: Transfer failed')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Fails for exchangeWrapper without enough tokens', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectBuyRevert({}, 'Token: TransferFrom failed')];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Fails for non-truthful exchangeWrapper', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all([
                        issueMakerTokenToWrapper(makerWei.div(2)),
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, expectBuyRevert({
                            order: __assign({}, testOrder, { makerAmount: makerWei.div(2) }),
...
function expectBuyOkay(glob, options) {
    return __awaiter(this, void 0, void 0, function () {
        var combinedGlob;
        return __generator(this, function (_a) {
            combinedGlob = __assign({}, defaultGlob, glob);
            return [2 /*return*/, solo.operation.initiate().buy(combinedGlob).commit(options)];
        });
    });
}
function expectBuyRevert(glob, reason, options) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Expect_1.expectThrow(expectBuyOkay(glob, options), reason)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
//# sourceMappingURL=Buy.test.js.map