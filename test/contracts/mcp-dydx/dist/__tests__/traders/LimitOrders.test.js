...
describe('LimitOrders', function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = testOrder;
                    return [4 /*yield*/, solo.limitOrders.signOrder(testOrder, types_1.SigningMethod.TypedData)];
                case 2:
                    _a.typedSignature =
                        _b.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = order;
                        return [4 /*yield*/, solo.limitOrders.signOrder(order, types_1.SigningMethod.Hash)];
                    case 1:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        order = __assign({}, testOrder);
                        _a = order;
                        return [4 /*yield*/, solo.limitOrders.signOrder(order, types_1.SigningMethod.TypedData)];
                    case 1:
                        _a.typedSignature = _b.sent();
                        expect(solo.limitOrders.orderHasValidSignature(order)).toBe(true);
                        return [2 /*return*/];
        ...
        it('Succeeds for eth.sign', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        order = __assign({}, testOrder);
                        return [4 /*yield*/, solo.limitOrders.signCancelOrder(order, types_1.SigningMethod.Hash)];
                    case 1:
                        cancelSig = _a.sent();
        ...
        it('Succeeds for eth_signTypedData', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        order = __assign({}, testOrder);
                        return [4 /*yield*/, solo.limitOrders.signCancelOrder(order, types_1.SigningMethod.TypedData)];
                    case 1:
                        cancelSig = _a.sent();
                        expect(solo.limitOrders.cancelOrderHasValidSignature(order, cancelSig)).toBe(true);
                        return [2 /*return*/];
    ...
    describe('shutDown', function () {
        it('Succeeds', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = expect;
                        return [4 /*yield*/, solo.limitOrders.isOperational()];
                    case 1:
                        _a.apply(void 0, [_c.sent()]).toBe(true);
                        return [4 /*yield*/, solo.contracts.send(solo.contracts.limitOrders.methods.shutDown(), { from: admin })];
                    case 2:
                        _c.sent();
                        _b = expect;
                        return [4 /*yield*/, solo.limitOrders.isOperational()];
        ...
        it('Succeeds when it is already shutDown', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, solo.contracts.send(solo.contracts.limitOrders.methods.shutDown(), { from: admin })];
                    case 1:
                        _c.sent();
                        _a = expect;
                        return [4 /*yield*/, solo.limitOrders.isOperational()];
        ...
        it('Fails for non-owner', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.contracts.send(solo.contracts.limitOrders.methods.shutDown(), { from: rando }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('startUp', function () {
        it('Succeeds after being shutDown', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _a.apply(void 0, [_c.sent()]).toBe(false);
                        return [4 /*yield*/, solo.contracts.send(solo.contracts.limitOrders.methods.startUp(), { from: admin })];
                    case 3:
                        _c.sent();
                        _b = expect;
                        return [4 /*yield*/, solo.limitOrders.isOperational()];
        ...
        it('Fails for non-owner', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.contracts.send(solo.contracts.limitOrders.methods.startUp(), { from: rando }))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('getTradeCost', function () {
        ...
        it('Succeeds for zero expiry', function () { return __awaiter(_this, void 0, void 0, function () {
            var testOrderNoExpiry, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        testOrderNoExpiry = __assign({}, testOrder, { expiration: Constants_1.INTEGERS.ZERO });
                        _a = testOrderNoExpiry;
                        return [4 /*yield*/, solo.limitOrders.signOrder(testOrderNoExpiry, types_1.SigningMethod.TypedData)];
                    case 1:
                        _a.typedSignature =
                            _b.sent();
        ...
        it('Succeeds for no specific taker', function () { return __awaiter(_this, void 0, void 0, function () {
            var testOrderNoTaker, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        testOrderNoTaker = __assign({}, testOrder, { takerAccountOwner: Constants_1.ADDRESSES.ZERO, takerAccountNumber: Constants_1.INTEGERS.ZERO });
                        _a = testOrderNoTaker;
                        return [4 /*yield*/, solo.limitOrders.signOrder(testOrderNoTaker, types_1.SigningMethod.TypedData)];
                    case 1:
                        _a.typedSignature =
                            _b.sent();
        ...
        it('Succeeds for pre-approved order', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: 
                    // approve order
                    return [4 /*yield*/, solo.limitOrders.approveOrder(testOrder, { from: testOrder.makerAccountOwner })];
                    case 1:
                        // approve order
                        _a.sent();
                        ...
                        // verify okay
                        return [4 /*yield*/, solo.operation.initiate().fillPreApprovedLimitOrder(defaultTakerAddress, defaultTakerNumber, testOrderNoSig, defaultTakerAmount, false).commit({ from: defaultTakerAddress })];
                    case 2:
                        // verify okay
                        _a.sent();
                        return [4 /*yield*/, expectBalances(Constants_1.INTEGERS.ZERO, defaultMakerAmount, defaultTakerAmount, Constants_1.INTEGERS.ZERO)];
        ...
        it('Fails if shutDown', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, {}), 'LimitOrders: Contract is not operational')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for inputWei of zero', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, { amount: Constants_1.INTEGERS.ZERO }), 'LimitOrders: InputWei is zero')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for inputMarket mismatch', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { inputMarketId: incorrectMarket })).commit({ from: defaultTakerAddress }), 'LimitOrders: Market mismatch')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for outputMarket mismatch', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { outputMarketId: incorrectMarket })).commit({ from: defaultTakerAddress }), 'LimitOrders: Market mismatch')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for switching makerMarket and takerMarket', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { inputMarketId: defaultMakerMarket, outputMarketId: defaultTakerMarket })).commit({ from: defaultTakerAddress }), 'LimitOrders: InputWei sign mismatch')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails to overfill order (takerAmount)', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, { amount: defaultTakerAmount.plus(5) }), 'LimitOrders: Cannot overfill order')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for canceled order', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, solo.limitOrders.cancelOrder(testOrder, { from: testOrder.makerAccountOwner })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, expectStatus(testOrder, types_1.LimitOrderStatus.Canceled)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, {}), 'LimitOrders: Order canceled')];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for expired order', function () { return __awaiter(_this, void 0, void 0, function () {
            var testOrderExpired, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        testOrderExpired = __assign({}, testOrder, { expiration: Constants_1.INTEGERS.ONE });
                        _a = testOrderExpired;
                        return [4 /*yield*/, solo.limitOrders.signOrder(testOrderExpired, types_1.SigningMethod.TypedData)];
                    case 1:
                        _a.typedSignature =
                            _b.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrderExpired, {}), 'LimitOrders: Order expired')];
                    case 2:
                        _b.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for incorrect taker account', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, { taker: rando }), 'LimitOrders: Order taker account mismatch')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, { takerNumber: defaultTakerNumber.plus(1) }), 'LimitOrders: Order taker account mismatch')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for incorrect maker account', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { otherAccountOwner: defaultTakerAddress })).commit({ from: defaultTakerAddress }), 'LimitOrders: Order maker account mismatch')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { otherAccountId: defaultMakerNumber.plus(1) })).commit({ from: defaultTakerAddress }), 'LimitOrders: Order maker account mismatch')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for invalid signature', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrderInvalidSig2, {}), 'LimitOrders: Order invalid signature')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrderShortSig, {}), 'LimitOrders: Cannot parse signature from data')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for bad data length', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(__assign({}, testOrder, { typedSignature: '0x0000' }), {}), 'LimitOrders: Cannot parse order from data')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(__assign({}, testOrder, { typedSignature: "0x" + '00'.repeat(100) }), {}), 'LimitOrders: Cannot parse order from data')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for bad order data', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().trade(__assign({}, limitOrderToTradeData(testOrder), { data: [[255], [255]] })).commit({ from: defaultTakerAddress }), 'LimitOrders: Cannot parse order from data')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        expectedDomainHash = solo.limitOrders.getDomainHash();
        ...
        it('Succeeds for null order', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, solo.limitOrders.approveOrder(testOrder, { from: approver })];
                    case 2:
                        txResult = _a.sent();
        ...
        it('Fails for canceled order', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(solo.limitOrders.approveOrder(testOrder, { from: testOrder.makerAccountOwner }), 'LimitOrders: Cannot approve canceled order')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('cancelOrder', function () {
        it('Succeeds for null order', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, solo.limitOrders.cancelOrder(testOrder, { from: canceler })];
                    case 2:
                        txResult = _a.sent();
                        return [4 /*yield*/, expectStatus(testOrder, types_1.LimitOrderStatus.Canceled)];
                    case 3:
        ...
        it('Succeeds for approved order', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, solo.limitOrders.approveOrder(testOrder, { from: testOrder.makerAccountOwner })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, expectStatus(testOrder, types_1.LimitOrderStatus.Approved)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, solo.limitOrders.cancelOrder(testOrder, { from: testOrder.makerAccountOwner })];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, expectStatus(testOrder, types_1.LimitOrderStatus.Canceled)];
                    case 4:
        ...
        it('Fails for non-maker', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.limitOrders.cancelOrder(testOrder, { from: rando }), 'LimitOrders: Canceler must be maker')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().call({
                                ...
                                data: BytesHelper_1.toBytes(badType, solo.limitOrders.getOrderHash(testOrder)),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.operation.initiate().call({
                            ...
                            primaryAccountId: testOrder.takerAccountNumber,
                            callee: solo.contracts.limitOrders.options.address,
                            data: BytesHelper_1.toBytes(solo.limitOrders.getOrderHash(testOrder)),
                        }).commit({ from: testOrder.takerAccountOwner }), 'LimitOrders: Cannot parse CallFunctionData')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('callFunction: approve', function () {
        function approveTestOrder(from) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, solo.operation.initiate().approveLimitOrder({
        ...
        it('Fails for non-Solo caller', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(solo.contracts.send(solo.contracts.limitOrders.methods.callFunction(Constants_1.ADDRESSES.ZERO, {
        ...
        it('Fails for canceled order', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, Expect_1.expectThrow(approveTestOrder(), 'LimitOrders: Cannot approve canceled order')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        it('Fails for non-maker', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(approveTestOrder(rando), 'LimitOrders: Approver must be maker')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('callFunction: cancel', function () {
        function cancelTestOrder(from) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, solo.operation.initiate().cancelLimitOrder({
                            primaryAccountOwner: from || testOrder.makerAccountOwner,
                            primaryAccountId: testOrder.makerAccountNumber,
                            order: testOrder,
                        }).commit({ from: from || testOrder.makerAccountOwner })];
        ...
        it('Fails for non-maker', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Expect_1.expectThrow(cancelTestOrder(rando), 'LimitOrders: Canceler must be maker')];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    describe('integration', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        _a.sent();
                        // fail a third time
                        return [4 /*yield*/, Expect_1.expectThrow(fillLimitOrder(testOrder, { amount: defaultTakerAmount.div(2) }), 'LimitOrders: Cannot overfill order')];
                    case 7:
                        // fail a third time
                        _a.sent();
                        return [2 /*return*/];
        ...
        it('Succeeds for logs', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        orderHash = solo.limitOrders.getOrderHash(testOrder);
                        return [4 /*yield*/, fillLimitOrder(testOrder, { amount: defaultTakerAmount.div(2) })];
                    case 1:
                        txResult1 = _a.sent();
                        return [4 /*yield*/, expectFilledAmount(testOrder, defaultMakerAmount.div(2))];
    ...
    describe('getOrderStates', function () {
        it('Succeeds for multiple orders', function () { return __awaiter(_this, void 0, void 0, function () {
            var canceler, approver, testOrderCancel, testOrderApprove, _a, _b, states1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        canceler = accounts[0];
                        approver = accounts[1];
                        testOrderCancel = __assign({}, testOrder, { makerAccountOwner: canceler });
                        testOrderApprove = __assign({}, testOrder, { makerAccountOwner: approver });
                        _a = testOrderCancel;
                        return [4 /*yield*/, solo.limitOrders.signOrder(testOrderCancel, types_1.SigningMethod.TypedData)];
                    case 1:
                        _a.typedSignature =
                            _c.sent();
                        _b = testOrderApprove;
                        return [4 /*yield*/, solo.limitOrders.signOrder(testOrderApprove, types_1.SigningMethod.TypedData)];
                    case 2:
                        _b.typedSignature =
                            _c.sent();
                        return [4 /*yield*/, Promise.all([
                    ...
                    case 3:
                        _c.sent();
                        return [4 /*yield*/, solo.limitOrders.getOrderStates([
                                testOrder,
                                testOrderCancel,
                                testOrderApprove,
                            ])];
    ...
    describe('getAccountCollateralizationAfterMakingOrders', function () {
        it('succeeds for x/0=infinity', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(solo.limitOrders.getAccountCollateralizationAfterMakingOrders([defaultMakerAmount, Constants_1.INTEGERS.ZERO], [new bignumber_js_1.default(2), new bignumber_js_1.default(1)], [testOrder], [testOrder.makerAmount])).toEqual(new bignumber_js_1.default(Infinity));
                return [2 /*return*/];
            });
        }); });
        it('succeeds for 0/0=infinity', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(solo.limitOrders.getAccountCollateralizationAfterMakingOrders([Constants_1.INTEGERS.ZERO, Constants_1.INTEGERS.ZERO], [], [], [])).toEqual(new bignumber_js_1.default(Infinity));
                return [2 /*return*/];
            });
        }); });
        it('succeeds for zero', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(solo.limitOrders.getAccountCollateralizationAfterMakingOrders([Constants_1.INTEGERS.ZERO, defaultTakerAmount.times(-1)], [new bignumber_js_1.default(2), new bignumber_js_1.default(1)], [testOrder], [testOrder.makerAmount])).toEqual(new bignumber_js_1.default(0));
                return [2 /*return*/];
            });
        }); });
        it('succeeds for one', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(solo.limitOrders.getAccountCollateralizationAfterMakingOrders([Constants_1.INTEGERS.ZERO, Constants_1.INTEGERS.ZERO], [new bignumber_js_1.default(2), new bignumber_js_1.default(1)], [testOrder], [testOrder.makerAmount])).toEqual(new bignumber_js_1.default(1));
                return [2 /*return*/];
            });
        }); });
        it('succeeds for two orders', function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(solo.limitOrders.getAccountCollateralizationAfterMakingOrders([Constants_1.INTEGERS.ZERO, Constants_1.INTEGERS.ZERO], [new bignumber_js_1.default(2), new bignumber_js_1.default(1)], [testOrder, testOrder], [testOrder.makerAmount.div(2), testOrder.makerAmount.div(2)])).toEqual(new bignumber_js_1.default(1));
                return [2 /*return*/];
            });
        }); });
    });
...
function fillLimitOrder(order, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_f) {
            return [2 /*return*/, solo.operation.initiate().fillSignedLimitOrder(taker, takerNumber, order, amount, denominatedInMakerAmount).commit({ from: taker })];
        });
    });
}
function limitOrderToTradeData(order) {
    return {
        ...
        data: BytesHelper_1.toBytes(solo.limitOrders.signedOrderToBytes(order)),
    };
}
...
function expectFilledAmount(order, expectedFilledAmount) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, solo.limitOrders.getOrderStates([order])];
                case 1:
                    states = _a.sent();
...
//# sourceMappingURL=LimitOrders.test.js.map