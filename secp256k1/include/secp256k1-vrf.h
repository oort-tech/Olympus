...
/** Generate a random output and a proof using the secret key and a message.
 *  Returns: 1 on success. 0 on failure.
 *  Out:    proof:   pointer to a 81-byte array to be filled by the function.
 *  In:     seckey:  pointer to a 32-byte private key.
 *          pubkey:  pointer to a secp256k1_pubkey containing an
 *                   initialized public key.
 *          msg:     pointer to the input message used to generate the
 *                   random output and the proof.
 *          msglen:  size in bytes of msg.
 */
 ...
 *          pk:      pointer to a 33-byte array containing the serialized
 *                   public key from the prover.
 *          msg:     pointer to the input message used to generate the proof.
 *          msglen:  size in bytes of msg.
 */
...
/** Retrieve the generated random output from a proof.
 *  Returns: 1 on success. 0 on failure.
 *  Out:    output:  pointer to a 32-byte array to be filled by the function.
 *  In:     proof:   pointer to a 81-byte array containing the proof.
 *
 *  ATTENTION: DO NOT USE this function without prior verification of the proof,
 *             unless the proof was just generated by this same application
 *             using the secp256k1_vrf_prove() function.
 *             Only use this function if the prove or verify succeded.
 */
